...
report={'version':5,'status':'passed','checks':checks,'themeFanGeometry':'identical','visualReview':'Final composites require visual review; wall-parallel bed revision','limits':'Layout guides plus 2D painted art, not an exact 3D reconstruction. Overview fan plate height has explicit art compensation.'}
